...
public ReportLinks(Document pdfDoc) {    
       ...
       // Table tabel = new Table(12);
        ...
        for (int i = 0; i < componentType.size(); i++){
            ...
            if (soortLink.length>1) {
                ...
                switch(soortLink[0]){
                    case "ShowPopup":       String[] linkSoortParams = soortLink[1].split(",");
                                            ...
                                            break;    
                    case "PreviousScreen":  tabel.addCell(cell.write(1, String.valueOf(indexRegelTeller)));
                                            tabel.addCell(cell.write(1, componentType.get(i)));
                                            tabel.addCell(cell.write(1, componentId.get(i)));
                                            tabel.addCell(cell.write(1, soortLink[0]));
                                            break;    
                    default:                tabel.addCell(cell.write(1, String.valueOf(indexRegelTeller)));
                                            tabel.addCell(cell.write(1, "Undefinded link type"));
                                            tabel.addCell(cell.write(1, ""));
                                            tabel.addCell(cell.write(1, soortLink[0]));
                }
